  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#272626]">
      ...
      <div className="flex flex-wrap justify-center gap-6">
        <img src={en1} alt="riot games" width={750} className=" cursor-pointer hover:outline outline-4 outline-white rounded-md"/>
        <img src={en2} alt="riot games" width={750} className=" cursor-pointer hover:outline outline-4 outline-white rounded-md"/>
      </div>
    </div>
  )
}
